...
#define MSG_OPERANDO                         _UxGT("Main loop")
#define MSG_KILN_SPRAY                       _UxGT("Nebulizar 30s")
#define MSG_KILN_VENT_MAS                    _UxGT("Acelera FAN")
#define MSG_KILN_VENT_MEN                    _UxGT("Decelera FAN")
#define MSG_KILN_ALARMA                      _UxGT("Alarma por parada")  //asegurar que se active
#define MSG_KILN_EXTRAE                      _UxGT("Extraer Humedad 30s")
#define MSG_KILN_PASO                        _UxGT("Avanzamos un paso")
#define MSG_KILN_TEMPOK                      _UxGT("Temperatura alcanzada")

#define WELCOME_MSG                         MACHINE_NAME _UxGT(" listo.")
#define MSG_BACK                            _UxGT("Atras")
#define MSG_SD_INSERTED                     _UxGT("Tarjeta colocada")
#define MSG_SD_REMOVED                      _UxGT("Tarjeta retirada")
#define MSG_LCD_ENDSTOPS                    _UxGT("Parada/") // Max length 8 characters //era endstops
...
#define MSG_PREHEAT_1                       _UxGT("Precalent.Kiln60") //era PLA   Asegurar que abra compuerta
...
#define MSG_PREHEAT_2                       _UxGT("Precalent.Agua 99")  //era ABS
...
#define MSG_NOZZLE                          _UxGT("Meta TempAgua")
#define MSG_BED                             _UxGT("Retorno")  //Cama
#define MSG_FAN_SPEED                       _UxGT("Bomba/255")
#define MSG_FLOW                            _UxGT("Flujo")
#define MSG_CONTROL                         _UxGT("Menu de EEPROM")
...
#define MSG_PAUSE_PRINT                     _UxGT("Pausar ciclo")   //
#define MSG_RESUME_PRINT                    _UxGT("Reanudar ciclo") //
#define MSG_STOP_PRINT                      _UxGT("Detener ciclo")  //
#define MSG_CARD_MENU                       _UxGT("Escoger ciclo...")
#define MSG_NO_CARD                         _UxGT("No hay tarjeta SD")
#define MSG_DWELL                           _UxGT("Reposo...")
#define MSG_USERWAIT                        _UxGT("Esperando ordenes")
#define MSG_PRINT_ABORTED                   _UxGT("Ciclo cancelado")  //
...
#define MSG_ERR_REDUNDANT_TEMP              _UxGT("Revisar termisores fallando")
...
#define MSG_HALTED                          _UxGT("Ciclo PARADO")
#define MSG_PLEASE_RESET                    _UxGT("Por favor, reinicie")
#define MSG_SHORT_DAY                       _UxGT("d") // One character only
#define MSG_SHORT_HOUR                      _UxGT("h") // One character only
#define MSG_SHORT_MINUTE                    _UxGT("m") // One character only
#define MSG_HEATING                         _UxGT("Calentando Kiln...")
#define MSG_BED_HEATING                     _UxGT("Calentando...")
...
#define MSG_INFO_MENU                       _UxGT("Inf. Kiln")
#define MSG_INFO_PRINTER_MENU               _UxGT("Inf. Kiln")
#define MSG_INFO_STATS_MENU                 _UxGT("Estadisticas Kiln")
...
#if LCD_WIDTH > 19
  #define MSG_INFO_PRINT_COUNT              _UxGT("Conteo de ciclos")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Ciclos Completados")
  #define MSG_INFO_PRINT_TIME               _UxGT("Tiempo tot. Kiln")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Ciclo mas largo")
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("Total de filn")
/*#else
...
#define MSG_FILAMENT_CHANGE_HEADER_PAUSE    _UxGT("Bomba PAUSADA")
