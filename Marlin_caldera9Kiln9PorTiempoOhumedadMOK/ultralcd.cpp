...
//  DEFINE_LCD_IMPLEMENTATION_DRAWMENU_SETTING_EDIT_TYPE(int16_t, int2, itostr2);  //dq
...
//    MENU_ITEM(submenu, MSG_CONTROL, lcd_control_menu);
  ...
  void lcd_control_menu() {
    START_MENU();
    MENU_BACK(MSG_MAIN);
 //DQ   MENU_ITEM(submenu, MSG_TEMPERATURE, lcd_control_temperature_menu);
 //DQ   MENU_ITEM(submenu, MSG_MOTION, lcd_control_motion_menu);
